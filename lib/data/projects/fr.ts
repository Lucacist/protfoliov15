...
const projects: Project[] = [
  {
    ...
    category: 'web',
    shortDescription:
      'Bibliothèque de composants Angular basée sur le modèle « copier-coller » popularisé par shadcn/ui : le code est copié dans votre projet, sans dépendance à maintenir. Une identité visuelle propre, pas un reskin de shadcn.',
    ...
    content: [
      {
        type: 'text',
        value:
          "Glyph est une bibliothèque de composants UI pour Angular, dans l'esprit de shadcn/ui, construite avec les signals, des composants standalone et Tailwind CSS v4. Projet actuellement en cours de développement.",
      },
      {
        type: 'heading',
        value: 'Pourquoi',
      },
      {
        type: 'text',
        value:
          "Avec une bibliothèque UI packagée, on finit par composer avec ses choix de style. Glyph reprend l'approche popularisée par shadcn/ui : le code source vit dans votre dépôt, vous pouvez donc modifier n'importe quel composant sans attendre une release ni surcharger ses styles.",
      },
      {
        type: 'heading',
        value: "Deux façons de l'utiliser",
      },
      {
        type: 'text',
        value:
          'CLI (recommandé) : copie le code source du composant dans votre projet, pour que vous en gardiez la maîtrise complète — `npx ngx-glyph init` puis `npx ngx-glyph add <composant>`. Package npm : installation classique via `@lucaffz/glyph`.',
      },
      {
        type: 'heading',
        value: 'Composants disponibles',
      },
      {
        type: 'text',
        value:
      ...
      },
      {
        type: 'text',
        value:
          'Angular 22, TypeScript, Tailwind CSS v4, Angular CDK, class-variance-authority et tailwind-merge pour la gestion des variantes, icônes Lucide via ng-icons. Versioning géré avec Changesets.',
      },
    ],
  },
  {
    ...
    category: 'web',
    shortDescription:
      "Refonte complète du site web d'une entreprise de logement social. Design moderne, responsive et optimisé pour la conversion.",
    technologies: ['Freelance', 'Web Design', 'SEO'],
    content: [
      {
        type: 'text',
        value:
          'Projet freelance de refonte complète du site web de SAIEM AGIRE, une entreprise de logement social. Détails à venir.',
      },
    ],
  },
  {
    ...
    category: 'web',
    shortDescription:
      "Plateforme web pour enseignants : gestion des notes par activité, génération de bulletins avec graphiques d'évolution et planification pédagogique.",
    technologies: [
      'Typescript',
      'PostgreSQL',
      'Next.js',
  ...
  },
  {
    ...
    category: 'web',
    shortDescription:
      "Développement d'un site vitrine moderne et responsive pour une entreprise de travaux. Optimisation SEO et design centré sur la conversion client.",
  ...
  },
  {
    ...
    technologies: ['C++', 'POO', 'Algorithmique', 'UI Graphique'],
  ...
  },
  {
    ...
    technologies: ['Arduino', 'C++', 'Capteurs I2C/SPI', 'RTC', 'Électronique'],
    nodownloadLabel:
      "Malheureusement, je n'ai pas le code sous la main. Si je le retrouve, je vous ferai signe.",
    content: [
      {
        type: 'text',
        value:
  ...
  },
  {
    ...
    category: 'web',
    shortDescription:
      "Extension PHP pour GLPI 10.x facilitant la gestion des accès Wi-Fi temporaires avec validation par ticket et création automatique d'identifiants.",
    technologies: ['PHP 7.4', 'GLPI API', 'MySQL', 'Plugin Architecture'],
    nodownloadLabel:
      "Code source non disponible au téléchargement (propriété de l'entreprise).",
    content: [
      {
        type: 'text',
        value:
          "Le plugin Guest Wifi est une extension destinée à GLPI 10.x qui facilite la gestion des accès Wi-Fi temporaires pour les visiteurs au sein d'une organisation. Il propose une interface claire et intuitive permettant de créer, suivre et gérer les comptes invités, avec une validation automatique prévue pour les accès de longue durée.",
      },
      {
        type: 'heading',
        value: 'Fonctionnalités principales :',
      ...
      },
      {
        type: 'text',
        value:
          "L'installation se fait en téléchargeant l'archive du plugin, en la décompressant dans le dossier plugins de GLPI, puis en l'activant depuis le menu Configuration > Plugins dans l'interface d'administration.",
      },
      {
        type: 'heading',
        value: 'Configuration :',
      },
      {
        type: 'text',
        value:
          "Une fois installé, il faut configurer les paramètres comme le groupe de gestionnaires autorisés et le seuil de jours pour la validation d'accès. La configuration s'effectue via le menu Guest Wifi > Configuration.",
      },
      {
        type: 'heading',
        value: 'Utilisation :',
      },
      {
        type: 'text',
        value:
          "Pour ajouter un invité, il suffit d'accéder au menu Guest Wifi > Ajouter un invité, de remplir les informations nécessaires et de valider. La gestion des invités s'effectue depuis la Liste des invités, où l'on peut consulter les statuts, filtrer les résultats ou supprimer un invité.",
      },
      {
        type: 'heading',
        value: 'Sécurité :',
      },
      {
        type: 'text',
        value:
          'Seuls les utilisateurs du groupe de gestionnaires configuré ont accès au plugin. Les identifiants Wi-Fi sont attribués de manière sécurisée, et les accès prolongés nécessitent une validation via le système de tickets.',
      },
    ],
  },
  {
    ...
    category: 'infra',
    shortDescription:
      "Création d'un dispositif de cybersécurité multi-niveaux pour protéger des prototypes. Intègre une authentification forte (MFA), la biométrie et des codes dynamiques.",
    technologies: ['Cybersécurité', 'MFA', 'Biométrie', 'Algorithmique'],
    ...
    content: [
      {
        type: 'text',
        value:
          'À la suite de plusieurs incidents liés au détournement de matériel, une agence de renseignement a sollicité notre expertise pour renforcer considérablement son système de sécurité.',
      },
      {
        type: 'heading',
      ...
      },
      {
        type: 'text',
        value:
          'Le prototype à sécuriser est au cœur d’un projet confidentiel et devra intégrer des mécanismes d’authentification avancés pour prévenir tout risque de compromission.',
      },
      {
        type: 'heading',
  ...
  },
  {
    ...
    category: 'iot',
    shortDescription:
      "Conception d'une technologie de communication furtive pour zones hostiles : conversion de la voix en signaux électriques inaudibles et analyse des émotions.",
    technologies: [
    ...
    content: [
      {
        type: 'text',
        value:
          'Ce projet a pour objectif de développer une solution de communication fonctionnelle dans des zones dépourvues de couverture réseau, notamment là où les ondes sont bloquées.',
      },
      {
        type: 'heading',
        value: 'Contexte :',
      },
      {
        type: 'text',
        value:
          "Suite à l'infiltration de l'agent K57, capturé dans une base de cyber-pirates inaccessible par les moyens traditionnels, il devient crucial d'éviter que ce type de situation se reproduise. Ce projet vise donc à concevoir une technologie adaptée aux environnements critiques.",
      },
      {
        type: 'heading',
        value: 'Fonctionnement :',
